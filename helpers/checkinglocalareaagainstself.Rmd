---
title: "Checking if Area between Self Curves Give 0"
author: "Tiffany Jann"
date: ""
output: 
  html_document:
...
includeSourceDocuments("checkinglocalareaagainstself.Rmd")
```
...
copy = read.tcsv(copyFile, header=T)
copy = copy - min(copy)
copy = copy / (max(copy) - min(copy))
...
scoresCopy = diffArea(copy, standard=gold)
scores = append(scores, scoresCopy)
```
